=== Bricks Extended Learndash Addon ===
Contributors: hlashbrooke
Donate link: http://www.appwizards.in/donate
...
Installing "Bricks Extended Learndash Addon" can be done either by searching for "Bricks Extended Learndash Addon" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
