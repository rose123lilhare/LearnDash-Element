 ...
 * Admin API class.
 */
class Bricks_Extended_Learndash_Addon_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'bricks-extended-learndash-addon' ) . '" data-uploader_button_text="' . __( 'Use image', 'bricks-extended-learndash-addon' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'bricks-extended-learndash-addon' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'bricks-extended-learndash-addon' ) . '" />' . "\n";
